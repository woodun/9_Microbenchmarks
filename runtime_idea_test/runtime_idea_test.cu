...
void init_cpu_data(long long int* A, long long int size, float stride){
...
__global__ void gpu_initialization(long long int *A, float data_stride, long long int data_size){			
...
__global__ void Page_visitor(long long int *A1, long long int *A2, long long int *B, float data_stride, long long int clock_count){////load-compute-store
	
	float temp = (blockIdx.x * blockDim.x + threadIdx.x) * data_stride;
...
int main(int argc, char **argv)
{
	...
	for(float data_stride = 1 * 1 * 0.25 * factor; data_stride <= 1 * 1 * 4 * factor; data_stride = data_stride * 2){///134217728 = 1gb, 268435456 = 2gb, 536870912 = 4gb, 1073741824 = 8gb, 2147483648 = 16gb, 4294967296 = 32gb, 8589934592 = 64gb. (index)
