...
__global__ void page_visitor5(long long int *A1, long long int *B, double data_stride, long long int clock_count, long long int offset){////proxy
...
__global__ void page_visitor7(long long int *A1, long long int *B, double data_stride, long long int clock_count, long long int offset, long long int time){////proxy
 ...
 __global__ void page_visitor6(long long int *A1, long long int *B, double data_stride, long long int clock_count, long long int offset){////proxy
...
int main(int argc, char **argv)
{
	...
	*/
	...
	for(long long int factor = 1; factor <= 16; factor = factor * 2){/////////////16384 (128k) max
	//printf("####################factor: %llu\n", factor);
	printf("\n");
	...
	if(time2 > clock_count){
		...
		page_visitor4<<<8192 * 512 / factor, 512>>>(CPU_data_in1, GPU_data_out1, data_stride, clock_count, offset, time2);
