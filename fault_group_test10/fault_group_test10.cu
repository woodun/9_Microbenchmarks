...
//////////////large vs small data.
//////test multiple warps. see blog trace. test blog 2 warps. blog improvement test. redo idea_test4 with correct timing. real applications prefetching + triggerring.
