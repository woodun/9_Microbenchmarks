...
int main(int argc, char **argv)
{
	...
	for(int data_stride = 2; data_stride <= 256; data_stride = data_stride * 2){
	...
	for(int data_stride = 4; data_stride <= 4; data_stride = data_stride * 2){
		printf("###################data_stride%d#########################\n", data_stride);
	for(int mod = 1024 * 256 * 1.5 + 64 * 1024; mod > 1024 * 256 * 1.5 - 32 * 1024; mod = mod - 8 * 1024){/////kepler L2 1.5m
