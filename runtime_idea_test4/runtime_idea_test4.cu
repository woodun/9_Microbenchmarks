...
int main(int argc, char **argv)
{
	...
	*/
	...
	for(long long int factor = 262144; factor <= 262144; factor = factor * 2){
	printf("####################factor: %llu\n", factor);	
	...
	printf("############baseline\n");
	for(long long int factor = 262144; factor <= 262144; factor = factor * 2){
	for(double data_stride = 1 * 1 * 1 * factor; data_stride <= 1 * 1 * 1 * factor; data_stride = data_stride * 2){///134217728 = 1gb, 268435456 = 2gb, 536870912 = 4gb, 1073741824 = 8gb, 2147483648 = 16gb, 4294967296 = 32gb, 8589934592 = 64gb. (index) 262144 = 2m.
	for(long long int clock_count = 8192; clock_count <= 8192; clock_count = clock_count * 2){
