...
int main(int argc, char **argv)
{
	...
	*/
	...
	for(long long int clock_count = 8; clock_count <= 4096; clock_count = clock_count * 2){
		...
		checkCudaErrors(cudaMallocManaged(&CPU_data_in1, sizeof(long long int) * data_size));
		long long int *CPU_data_in2;
		checkCudaErrors(cudaMallocManaged(&CPU_data_in2, sizeof(long long int) * data_size));
		///////////////////////////////////////////////////////////////////CPU data end
		
		long long int *GPU_data_out1;
		checkCudaErrors(cudaMallocManaged(&GPU_data_out1, sizeof(long long int) * data_size));
		long long int *GPU_data_out2;
		checkCudaErrors(cudaMallocManaged(&GPU_data_out2, sizeof(long long int) * data_size));
		///////////////////////////////////////////////////////////////////GPU data out	end
