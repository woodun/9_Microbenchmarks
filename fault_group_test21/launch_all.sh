...
do
cat temp_fault_group_test21.cu | sed "s/#define STRIDE_64K 256/#define STRIDE_64K $i/" | sed "s/#define dimx 512/#define dimx $dimx/" | sed "s/#define dimy 512/#define dimy $dimy/" > fault_group_test21.txt
make > dump_make.txt
./fault_group_test21
