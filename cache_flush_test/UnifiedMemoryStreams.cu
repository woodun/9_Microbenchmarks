...
__global__ void tlb_latency_test(int *A, int iterations, int *B, float clock_rate){	
	...
	P_chasing(0, A, 16, B, 15 * 524288, clock_rate);/////warmup
	P_chasing(0, A, 16, B, 16 * 524288, clock_rate);/////try to generate TLB miss and cache miss
	P_chasing(0, A, 16, B, 16 * 32, clock_rate);/////warmup TLB, TLB miss and cache miss
	P_chasing(1, A, 16, B, 0, clock_rate);/////try to generate TLB hit and cache miss
	P_chasing(2, A, 16, B, 0, clock_rate);/////try to generate TLB hit and cache hit
	P_chasing(3, A, 16, B, 0, clock_rate);/////try to generate TLB hit and cache hit
...
__global__ void tlb_latency_test_3(int *A, int iterations, int *B, float clock_rate){	
	...
	P_chasing(12, A, 16, B, 524288, clock_rate);/////try to generate TLB miss and cache miss
	P_chasing(13, A, 16, B, 0, clock_rate);/////try to generate TLB hit and cache hit
...
__global__ void tlb_latency_test_4(int *A, int iterations, int *B, float clock_rate){	
	...
	//P_chasing(0, A, 1, B, 31 * 32, clock_rate);/////warmup TLB
	P_chasing(17, A, 16, B, 524288, clock_rate);/////warmup
	...
	P_chasing(19, A, 16, B, 17 * 524288 + 16 * 32, clock_rate);/////try to generate TLB miss and cache miss
}
