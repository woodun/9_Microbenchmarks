...
int main(int argc, char **argv)
{
	...
	*/
	...
	for(double data_stride = 4294967296 * factor; data_stride <= 4294967296 * factor; data_stride = data_stride + 536870912){///134217728 = 1gb, 268435456 = 2gb, 536870912 = 4gb, 1073741824 = 8gb, 2147483648 = 16gb, 4294967296 = 32gb, 8589934592 = 64gb. (index)
	//printf("\n");
