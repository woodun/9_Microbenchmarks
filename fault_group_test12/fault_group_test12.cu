...
//////////////large vs small data.
//////creating 2 blocks doing exactly the same thing? method in the blog. imrovement + baseline.
...
int main(int argc, char **argv)
{
	...
	*/
	...
	for(double data_stride = 2147483648 * factor; data_stride <= 2147483648 * factor; data_stride = data_stride + 536870912){///134217728 = 1gb, 268435456 = 2gb, 536870912 = 4gb, 1073741824 = 8gb, 2147483648 = 16gb, 4294967296 = 32gb, 8589934592 = 64gb. (index)
	//printf("\n");
	...
	//}
		...
		stream_thread_imp<<<512, 512>>>(CPU_data_in1, 8 * data_size, GPU_data_out1, 7);
	...
	//}
		...
		stream_warp_imp<<<512, 512>>>(CPU_data_in1, 8 * data_size, GPU_data_out1, 7);
