...
int main(int argc, char **argv)
{
	...
	*/
	...
	//}
		...
		page_visitor4<<<block_num, 512>>>(CPU_data_in1, GPU_data_out1, data_stride, clock_count);///////1 warp 1 data
	...
	for(long long int clock_count = 15; clock_count <= 15; clock_count = clock_count + 1){
