...
int main(int argc, char **argv)
{
	...
	///is it still true that in multi threads the dynamic page threshold is still 64k? 
	for(long long int data_stride = 1 * 16 * 1024; data_stride <= 1 * 16 * 1024; data_stride = data_stride * 2){
